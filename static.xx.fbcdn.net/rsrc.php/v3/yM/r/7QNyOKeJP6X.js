...
__d("QPLCore", ["QPLEvent", "QPLTimestamp", "QPLUtils", "QuickPerformanceLoggerTypes", "uuidv4"], (function(a, b, c, d, e, f, g) {
    ...
    var o = function() {
        ...
        b.markerStartForJoin = function(a, b, c) {
            ...
            k = "unreliable";
            c != null && (k += "_" + c);
            this.markerAnnotate(a, {
                string: (e = {}, e.join_id = b, e.qpl_join__source_clock = k, e.qpl__source = "client_js", e),
...
__d("QuickPerformanceLogger", ["Arbiter", "Env", "FBLogger", "PerfFalcoEvent", "PerfXSharedFields", "Promise", "QPLCore", "QPLEvent", "QPLInspector", "Run", "USID", "WebStorage", "cr:1984081", "cr:686", "gkx", "performanceAbsoluteNow", "performanceNavigationStart", "performanceNow"], (function(a, b, c, d, e, f, g) {
    ...
    function q(a, d) {
        return new(m || (m = b("Promise")))(function() {
            ...
            c("gkx")("21053") || c("gkx")("20935") || c("gkx")("21054") || c("gkx")("5679") ? c("PerfFalcoEvent").logImmediately(function() {
                return b
    ...
    a = function(a) {
        ...
        f.markerStartForJoinFromNavStart = function(a, b, d) {
            ...
            d = d.unreliableSourceClockProcessId;
            var n = c("performanceNavigationStart")();
            j = typeof j === "function" ? j(n) : void 0;
            this.markerStartForJoin(a, b, {
                ...
                sourceIsPrimary: l,
                closeSession: m,
                unreliableSourceClockProcessId: d
            });
            if (c("performanceNavigationStart").isPolyfilled) {
...
__d("LoginInitialLoadLogger", ["QuickLogActionType", "QuickPerformanceLogger", "Run", "qpl"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i = 1,
        j = 2;
    a = {
        onLoad: function(a) {
            (h || (h = c("QuickPerformanceLogger"))).markerStartFromNavStart(c("qpl")._(250350617, "2444"), i);
            var b = h.currentTimestamp();
            h.markerStart(c("qpl")._(250350617, "2444"), j, b);
            d("Run").onLoad(function() {
                (h || (h = c("QuickPerformanceLogger"))).markerAnnotate(c("qpl")._(250350617, "2444"), {
                    string: {
                        tracePolicy: "blue." + a,
                        type: "onLoad"
                    }
            ...
            var e = new PerformanceObserver(function(d) {
                d = d.getEntries();
                ...
                h.markerEnd(c("qpl")._(250350617, "2444"), c("QuickLogActionType").SUCCESS, j, b + d.startTime)
            });
            e.observe({
